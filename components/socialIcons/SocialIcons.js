...
import { FaDev, FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaTwitter, FaYoutube, FaStackOverflow } from 'react-icons/fa';
...
const SocialIcons = () => (
    <div className={styling.social}>
        ...
        <a href={blogConfig.social.stackoverflow} target='_blank' rel='noreferrer' hidden={!blogConfig.social.stackoverflow}>
            <FaStackOverflow />
        </a>
    </div>
);
